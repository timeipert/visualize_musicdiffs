...
// node_modules/neighbor-joining/dist/utils.js
var require_utils = __commonJS({
  "node_modules/neighbor-joining/dist/utils.js"(exports) {
    "use strict";
    ...
    function allocateSquareMatrix(n) {
      var value = arguments.length <= 1 || arguments[1] === void 0 ? null : arguments[1];
      var a = new Array(n);
      for (var i = 0; i < n; i++) {
        a[i] = new Array(n);
    ...
    function arrayCopy(a) {
      var b = new Array(a.length), i = a.length;
      while (i--) {
        b[i] = a[i];
      }
      return b;
    ...
    function sumRows(a) {
      var sum = void 0, n = a.length, sums = new Array(n);
      for (var i = 0; i < n; i++) {
        sum = 0;
        for (var j = 0; j < n; j++) {
          if (a[i][j] === void 0) continue;
          sum += a[i][j];
        }
        sums[i] = sum;
      }
    ...
    function sortWithIndices(toSort) {
      var skip = arguments.length <= 1 || arguments[1] === void 0 ? -1 : arguments[1];
      var timsort = arguments.length <= 2 || arguments[2] === void 0 ? false : arguments[2];
      var n = toSort.length;
...
// node_modules/neighbor-joining/dist/neighbor-joining.js
var require_neighbor_joining = __commonJS({
  "node_modules/neighbor-joining/dist/neighbor-joining.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.RapidNeighborJoining = void 0;
    ...
    var RapidNeighborJoining = exports.RapidNeighborJoining = (function() {
      function RapidNeighborJoining2(D, taxa) {
        var copyDistanceMatrix = arguments.length <= 2 || arguments[2] === void 0 ? false : arguments[2];
        var taxonIdAccessor = arguments.length <= 3 || arguments[3] === void 0 ? function(d) {
          return d.name;
        } : arguments[3];
        _classCallCheck(this, RapidNeighborJoining2);
        ...
        this.nextIndex = N;
        this.initializeSI();
        this.removedIndices = /* @__PURE__ */ new Set();
        this.indicesLeft = /* @__PURE__ */ new Set();
      ...
      _createClass(RapidNeighborJoining2, [{
        key: "initializeSI",
        ...
        value: function search() {
          var qMin = Infinity, D = this.D, cN = this.cN, n2 = cN - 2, S = this.S, I = this.I, rowSums = this.rowSums, removedColumns = this.removedIndices, uMax = this.rowSumMax, q = void 0, minI = -1, minJ = -1, c2 = void 0;
        ...
        key: "run",
        value: function run() {
          var minI = void 0, minJ = void 0, d1 = void 0, d2 = void 0, l1 = void 0, l2 = void 0, node1 = void 0, node2 = void 0, node3 = void 0, self = this;
        ...
        value: function recalculateDistanceMatrix(joinedIndex1, joinedIndex2) {
          var D = this.D, n = D.length, sum = 0, aux = void 0, aux2 = void 0, removedIndices = this.removedIndices, rowSums = this.rowSums, newRow = this.newRow, rowChange = this.rowChange, newMax = 0;
      ...
      return RapidNeighborJoining2;
    })();
    var PhyloNode = (function() {
      function PhyloNode2() {
        var taxon = arguments.length <= 0 || arguments[0] === void 0 ? null : arguments[0];
        var length = arguments.length <= 1 || arguments[1] === void 0 ? null : arguments[1];
        var child1 = arguments.length <= 2 || arguments[2] === void 0 ? null : arguments[2];
        var child2 = arguments.length <= 3 || arguments[3] === void 0 ? null : arguments[3];
        _classCallCheck(this, PhyloNode2);
        this.taxon = taxon;
        this.length = length;
        this.children = [];
...
// node_modules/neighbor-joining/index.js
var require_neighbor_joining2 = __commonJS({
  "node_modules/neighbor-joining/index.js"(exports, module) {
    module.exports = {
      RapidNeighborJoining: require_neighbor_joining().RapidNeighborJoining,
      allocateSquareMatrix: require_utils().allocateSquareMatrix
    };
  }
});
export default require_neighbor_joining2();
//# sourceMappingURL=neighbor-joining.js.map
